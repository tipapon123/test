...
const Promotion = ({promotion,navmenus}) => {


  return (
    <>
   <Head>
        <title>{promotion.attributes.Title}</title>
        <meta name="description" content={promotion.attributes.Description} />
        <link rel="canonical" href={`${promotion.attributes.canonical}`} ></link>
     ...
     <NavBar navmenus={navmenus.items} />
      ...
      <Markdown>{promotion.attributes.body}</Markdown>
      </div>
      </div>
